...
var KatexComponent_1;
import * as Katex from 'katex';
import { Injectable, Component, ComponentSetter, LeafAbstractComponent, VElement, I18n } from '@textbus/core';
import { Form, FormTextarea } from '@textbus/uikit';
...
let KatexComponentLoader = class KatexComponentLoader {
    match(element) {
...
KatexComponentLoader = __decorate([
    Injectable()
], KatexComponentLoader);
let KatexComponentSetter = class KatexComponentSetter {
    constructor(i18n) {
        this.i18n = i18n;
    }
    create(instance) {
        const textarea = new FormTextarea({
            name: 'source',
            placeholder: this.i18n.get('components.katexComponent.setter.placeholder'),
            label: '',
        ...
        const form = new Form({
            mini: true,
            confirmBtnText: this.i18n.get('components.katexComponent.setter.confirmBtnText'),
            items: [
                textarea
            ]
        });
        ...
        return {
            title: this.i18n.get('components.katexComponent.setter.title'),
            view: form.elementRef
        };
    }
};
KatexComponentSetter = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [I18n])
], KatexComponentSetter);
export { KatexComponentSetter };
let KatexComponent = KatexComponent_1 = class KatexComponent extends LeafAbstractComponent {
    constructor(source = defaultSource) {
        super('tb-katex');
        this.source = source;
        this.block = false;
    }
    ...
    clone() {
        return new KatexComponent_1(this.source);
    }
};
KatexComponent = KatexComponent_1 = __decorate([
    Component({
...
export const katexComponentExample = {
    name: i18n => i18n.get('components.katexComponent.creator.name'),
    ...
    factory(dialog, _, i18n) {
        const childI18n = i18n.getContext('components.katexComponent.creator.form');
        const textarea = new FormTextarea({
            name: 'source',
...
//# sourceMappingURL=katex.component.js.map