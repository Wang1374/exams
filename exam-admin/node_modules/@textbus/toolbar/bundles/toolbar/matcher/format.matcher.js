import { BranchAbstractComponent, FormatEffect, DivisionAbstractComponent, } from '@textbus/core';
import { HighlightState } from '../help';
import { rangeContentInComponent } from './utils/range-content-in-component';
export class FormatMatcher {
    constructor(formatter, excludeComponents = []) {
    ...
    queryState(selection) {
        ...
        const srcStates = selection.ranges.map(range => {
    ...
    getStatesByRange(fragment, formatter, startIndex, endIndex) {
            ...
            for (const format of formatRanges) {
                ...
                if (matchBegin && matchClose) {
                    return {
                        ...
                        srcData: (format === null || format === void 0 ? void 0 : format.formatData.clone()) || null
                    };
                }
            }
            return {
    ...
    static inSingleContainer(fragment, formatter, startIndex, endIndex) {
        while (true) {
