...
export class TdBorderColorCommander {
    constructor() {
        ...
        selectedCells.forEach(c => {
            ...
            if (color) {
                ...
                if (c.rowIndex === minRow) {
                    const prev = (_a = cellMatrix[minRow - 1]) === null || _a === void 0 ? void 0 : _a.cellsPosition[c.columnIndex].cell;
                    if (prev) {
                        const f = prev.fragment.getFormatRanges(tdBorderColorFormatter);
                        if (f.length) {
                            f.forEach(ff => {
...
//# sourceMappingURL=td-border-color.commander.js.map