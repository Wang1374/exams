...
import { SelectTool } from '../toolkit/_api';
export const fontFamilyToolConfig = {
    ...
    matchOption(data) {
        if (data instanceof FormatData) {
            for (const option of fontFamilyToolConfig.options) {
                if (new RegExp(`^['"]?${option.value}['"]?$`).test(data.styles.get('fontFamily'))) {
                    return option;
                }
            }
        }
...
//# sourceMappingURL=font-family.tool.js.map