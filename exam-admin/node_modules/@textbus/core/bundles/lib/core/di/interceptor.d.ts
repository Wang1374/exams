 ...
 * TextBus 事件对象。
 */
export declare class TBEvent<T extends AbstractComponent, U = null> {
    instance: T;
    data: U;
    /**
     * 是否已阻止事件冒泡。
 ...
 */
export declare abstract class Interceptor<T extends AbstractComponent> {
    /**
     * 在当前组件下输入功能就绪时调用
     * @param event
     */
