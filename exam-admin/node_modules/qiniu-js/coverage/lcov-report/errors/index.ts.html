...
<head>
    <title>Code coverage report for errors/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">errors</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L63'></a><a href='#L63'>63</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export enum QiniuErrorName {
  // 输入错误
...
export class QiniuNetworkError extends QiniuRequestError {
  constructor(message: string, <span class="missing-if-branch" title="if path not taken" >I</span>reqId = '') {
    super(0, reqId, message)<span class="branch-1 cbranch-no" title="branch not covered" ></span>
  }
}
&nbsp;</pre></td></tr></table></pre>
