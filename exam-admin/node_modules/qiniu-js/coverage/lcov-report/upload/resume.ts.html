...
<head>
    <title>Code coverage report for upload/resume.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">upload</a> resume.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.44% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>102/108</span>
            </div>
...
<a name='L299'></a><a href='#L299'>299</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { uploadChunk, uploadComplete, initUploadParts, UploadChunkData } from '../api'
...
&nbsp;
  ...
  protected async run() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.config.chunkSize || !isPositiveInteger(this.config.chunkSize)) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.chunkSize &gt; 1024) {
<span class="cstat-no" title="statement not covered" >      throw new QiniuError(</span>
        QiniuErrorName.InvalidChunkSize,
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cachedInfo &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >md5 === cachedInfo.md5)</span> {
<span class="cstat-no" title="statement not covered" >      reuseSaved()</span>
...
&nbsp;
    const requestOptions = {
      body: chunk,
      onProgress,
      onCreate: <span class="fstat-no" title="function not covered" >(x</span>hr: XMLHttpRequest) =&gt; <span class="cstat-no" title="statement not covered" >this.addXhr(xhr)</span>
    }
&nbsp;
...
&nbsp;
  private async mkFileReq() {
    const data: UploadChunkBody = {
      ...
      ...this.putExtra.mimeType &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >{ mimeType: this.putExtra.mimeType },</span>
      ...this.putExtra.customVars &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >{ customVars: this.putExtra.customVars },</span>
      ...this.putExtra.metadata &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >{ metadata: this.putExtra.metadata }</span>
    }
&nbsp;
