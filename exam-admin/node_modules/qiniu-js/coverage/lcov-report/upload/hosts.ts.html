...
<head>
    <title>Code coverage report for upload/hosts.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">upload</a> hosts.ts</h1>
        <div class='clearfix'>
...
<a name='L128'></a><a href='#L128'>128</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { getUpHosts } from '../api'
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (response<span class="branch-0 cbranch-no" title="branch not covered" >?.d</span>ata != null) {
      const stashHosts: string[] = [
        ...(response.data.up<span class="branch-0 cbranch-no" title="branch not covered" >?.a</span>cc<span class="branch-0 cbranch-no" title="branch not covered" >?.m</span>ain || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>,
        ...(response.data.up<span class="branch-0 cbranch-no" title="branch not covered" >?.a</span>cc<span class="branch-0 cbranch-no" title="branch not covered" >?.b</span>ackup || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>
      ]
...
&nbsp;
  ...
  public async getUp(accessKey: string, bucketName: string, protocol: InternalConfig['upprotocol']): Promise&lt;Host | null&gt; {
    ...
    const cachedHostList = this.cachedHostsMap.get(`${accessKey}@${bucketName}`) || <span class="branch-1 cbranch-no" title="branch not covered" >[]</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cachedHostList.length === 0) <span class="cstat-no" title="statement not covered" >return null</span>
...
&nbsp;
    ...
    const priorityQueue = cachedHostList
      .slice().sort(
        (hostA, hostB) =&gt; (hostA.getUnfreezeTime() || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> - (hostB.getUnfreezeTime() || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>
      )
&nbsp;
