...
<head>
    <title>Code coverage report for upload/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">upload</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L77'></a><a href='#L77'>77</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Resume from './resume'
...
export function createUploadManager(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.config &amp;&amp; options.config.forceDirect) {
<span class="cstat-no" title="statement not covered" >    logger.info('ues forceDirect mode.')</span>
<span class="cstat-no" title="statement not covered" >    return new Direct(options, handlers, hostPool, logger)</span>
  }
&nbsp;
...
&nbsp;
  // 为每个任务创建单独的 Logger
  const logger = new Logger(token, <span class="branch-1 cbranch-no" title="branch not covered" >config?.disableStatisticsReport,</span> <span class="branch-1 cbranch-no" title="branch not covered" >config?.debugLogLevel,</span> file.name)
&nbsp;
