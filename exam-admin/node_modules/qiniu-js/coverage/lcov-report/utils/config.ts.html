...
<head>
    <title>Code coverage report for utils/config.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> config.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (logger &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >config?.uphost </span>!= null &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >config?.region != null)</span> {
<span class="cstat-no" title="statement not covered" >    logger.warn('do not use both the uphost and region config.')</span>
  }
&nbsp;
...
&nbsp;
  ...
  } else if (normalizeConfig<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>egion) {
    const hostMap = regionUphostMap[normalizeConfig<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>egion]
