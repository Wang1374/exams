...
<head>
    <title>Code coverage report for utils/observable.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> observable.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/** 消费者接口 */
...
&nbsp;
  /** 取消 observer 的订阅 */
<span class="fstat-no" title="function not covered" >  unsubscribe(</span>) {
...
<span class="cstat-no" title="statement not covered" >    if (this._unsubscribe) {</span>
<span class="cstat-no" title="statement not covered" >      this._unsubscribe()</span>
    }
  }
&nbsp;
...
&nbsp;
  constructor(
    ...
    super()
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (observerOrNext &amp;&amp; typeof observerOrNext === 'object') {
      this.destination = observerOrNext
    } else {
<span class="cstat-no" title="statement not covered" >      this.destination = {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  unsubscribe(</span>): void {
<span class="cstat-no" title="statement not covered" >    if (this.closed) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.isStopped = true</span>
<span class="cstat-no" title="statement not covered" >    super.unsubscribe()</span>
  }
&nbsp;
  next(value: T) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isStopped &amp;&amp; this.destination.next) {
<span class="cstat-no" title="statement not covered" >      this.destination.next(value)</span>
    }
  }
&nbsp;
  error(err: E) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isStopped &amp;&amp; this.destination.error) {
      this.isStopped = true
...
&nbsp;
  complete(result: C) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isStopped &amp;&amp; this.destination.complete) {
      this.isStopped = true
