...
<head>
    <title>Code coverage report for api/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">api</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L173'></a><a href='#L173'>173</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { stringify } from 'querystring'
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return `${url}/buckets/${bucket}/objects/${key != null ? utils.urlSafeBase64Encode(key) : '~'}/uploads/${id}`</span>
}
&nbsp;
...
export function <span class="fstat-no" title="function not covered" >initUploadParts(</span>
  ...
  const url = `${<span class="cstat-no" title="statement not covered" >uploadUrl}/buckets/${bucket}/objects/${key != null ? utils.urlSafeBase64Encode(key) : '~'}/uploads`</span>
...
export function <span class="fstat-no" title="function not covered" >uploadChunk(</span>
  ...
  const bucket = <span class="cstat-no" title="statement not covered" >utils.getPutPolicy(token).bucketName</span>
 ...
 * @description 直传接口
 */
export function <span class="fstat-no" title="function not covered" >direct(</span>
  url: string,
  data: FormData,
  options: Partial&lt;utils.RequestOptions&gt;
