...
<head>
    <title>Code coverage report for api/index.mock.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">api</a> index.mock.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { QiniuNetworkError, QiniuRequestError } from '../errors'
import * as api from '.'
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public d</span>eleteUploadedChunks(): ReturnType&lt;typeof api.deleteUploadedChunks&gt; {
    const defaultData: ReturnType&lt;typeof api.deleteUploadedChunks&gt; = <span class="cstat-no" title="statement not covered" >Promise.resolve({</span>
      reqId: 'req-id',
      data: undefined
    })
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callInterceptor('deleteUploadedChunks', defaultData)</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
