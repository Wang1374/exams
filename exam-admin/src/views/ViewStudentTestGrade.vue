<template>
  <el-dialog title="答案解析" v-model="centerDialogVisible" width="40%">
    <div v-html="analysis"></div>
    <template #footer>
      <span class="dialog-footer">
        <el-button type="primary" @click="centerDialogVisible = false">明白了</el-button>
        <el-button type="danger" @click="bmb()">不明白</el-button>
      </span>
    </template>
  </el-dialog>
  <div class="markTestPaper testPaper" style="width:100%" v-loading="loading">
    <div class="">
      <!-- 考试信息 -->
      <div class="title">
                  ...
                  <div class="left">
                    <div class="question">
                      <el-row>
                        ...
                        <el-col :span="2">
                          <el-button size="mini" type="info" @click="queryJx(t.topic)">查看解析</el-button>
                        </el-col>
                        <el-col :span="2">
                          <span class="score">
...
export default {
  ...
  methods: {
    ...
    getTestPaperData() {
      this.loading = true;
      let id = sessionStorage.getItem("examQueryGradeUserId");
      request
